...
public class AdminController {
     ...
     * @return ResponseEntity with the Admin object if it exists, or a not found response if the admin is not found.
     */
    @GetMapping("/{id}")
     ...
     * @return ResponseEntity with the created Admin object if successful, or an internal server error response if the creation fails.
     */
    @PostMapping("/create")
     ...
     * @return ResponseEntity with the updated Admin object if successful, or a not found response if the admin is not found.
     */
    @PutMapping("/{id}")
     ...
     * @return ResponseEntity with a success message if the deletion is successful, or a not found response if the admin is not found.
     */
    @DeleteMapping("/{id}")
